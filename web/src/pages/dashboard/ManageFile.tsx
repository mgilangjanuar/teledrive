...
import FloatingBtn from './components/ManageFile/FloatingBtn'
...
function ManageFile(): React.ReactElement {
  ...
  return (
    <Box bg={useColorModeValue('gray.50', 'gray.800')} minH="100vh">
      <Container maxW="1400px" mx="auto" padding="0" position="relative">
        <Nav />
          ...
          <Box w={['sm', 'md', '2xl']} mt="10" bg="white" minH="100vh">
            <Tabs isFitted variant="enclosed">
              <TabList>
                ...
                <Tab _selected={TabVariant}>Document</Tab>
